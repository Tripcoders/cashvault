...
export const CATEGORIES: Category[] = [
  { id: 'bank-logs', name: 'Bank Logs', iconName: 'database', count: 142 },
  { id: 'office-365', name: 'Office 365 Leads', iconName: 'globe', count: 850 },
  { id: 'cash-out', name: 'Cash Out Methods', iconName: 'exchange', count: 30 },
  { id: 'otp-bot', name: 'OTP BOT', iconName: 'smartphone', count: 15 },
  { id: 'cc-topup', name: 'Credit Card Top Up', iconName: 'credit-card', count: 25 },
  { id: 'rat', name: 'RAT (Remote Access)', iconName: 'shield', count: 20 },
  { id: 'rdp', name: 'Powerful RDP', iconName: 'server', count: 35 },
  { id: 'paypal', name: 'PayPal Accounts', iconName: 'wifi', count: 18 },
]
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 650,
    grade: 'Medium',
    description: 'Wells Fargo account with $5,000 - $8,000 balance. Good for quick cashouts.',
    features: ['Balance: $5k-$8k', 'User Agent Included', 'Full Info'],
  ...
  },
  {
    ...
    price: 350,
    grade: 'Low',
    description: 'Bank of America account with $1,000 - $3,000 balance. Perfect for beginners.',
    features: ['Balance: $1k-$3k', 'Login Only'],
  ...
  },
  {
    ...
    price: 550,
    grade: 'Medium',
    description: 'Capital One account with verified balance. Includes full login credentials.',
    features: ['Balance: $4k-$7k', 'Login Credentials', 'Recent Activity'],
